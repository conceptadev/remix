...
SidebarStyler vanillaSidebarStyle({
  SidebarStyler style = const SidebarStyler.create(),
}) => SidebarStyler(
  container: FlexBoxStyler()
      .color(VanillaTokens.background())
      .border(.end(.color(VanillaTokens.border()).width(_borderWidth))),
  content: FlexBoxStyler()
      ...
      .spacing(_sectionGap),
  footer: BoxStyler()
      .border(.top(.color(VanillaTokens.border()).width(_borderWidth)))
  ...
  destination: vanillaToggleStyle(variant: .ghost, size: .medium)
