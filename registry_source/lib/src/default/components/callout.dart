...
CalloutStyler _variantStyle(VanillaCalloutVariant variant) => switch (variant) {
  .neutral => _toned(
    fill: VanillaTokens.muted(),
    outline: VanillaTokens.border(),
    icon: VanillaTokens.mutedForeground(),
  ),
  .destructive => _toned(
    fill: _noFill,
    outline: VanillaTokens.destructive(),
    icon: VanillaTokens.destructive(),
  ),
};
