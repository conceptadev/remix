...
class VanillaIconButton extends StatelessWidget {
  ...
  const VanillaIconButton.primary({
    super.key,
    this.size = .medium,
    this.style = const IconButtonStyler.create(),
    required this.icon,
    ...
    this.excludeSemantics = false,
    this.mouseCursor = SystemMouseCursors.click,
  }) : variant = VanillaIconButtonVariant.primary;

  /// Medium emphasis: a solid `secondary` fill.
  const VanillaIconButton.secondary({
    super.key,
    this.size = .medium,
    this.style = const IconButtonStyler.create(),
    required this.icon,
  ...
  const VanillaIconButton.outline({
    ...
    this.excludeSemantics = false,
    this.mouseCursor = SystemMouseCursors.click,
  }) : variant = VanillaIconButtonVariant.outline;

  /// Low emphasis with no fill and no border.
  const VanillaIconButton.ghost({
    super.key,
    this.size = .medium,
    this.style = const IconButtonStyler.create(),
    required this.icon,
    ...
    this.excludeSemantics = false,
    this.mouseCursor = SystemMouseCursors.click,
  }) : variant = VanillaIconButtonVariant.ghost;

  /// Highest emphasis for irreversible actions.
  const VanillaIconButton.destructive({
    super.key,
    this.size = .medium,
    this.style = const IconButtonStyler.create(),
    required this.icon,
    ...
    this.excludeSemantics = false,
    this.mouseCursor = SystemMouseCursors.click,
  }) : variant = VanillaIconButtonVariant.destructive;

  final VanillaIconButtonVariant variant;

  final VanillaIconButtonSize size;
