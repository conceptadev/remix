...
class VanillaToggleGroup<T> extends StatelessWidget {
  const VanillaToggleGroup({
    super.key,
    this.variant = .ghost,
    this.size = .medium,
  ...
  const VanillaToggleGroup.ghost({
    super.key,
    this.size = .medium,
    this.style = const ToggleGroupStyler.create(),
    required this.items,
    ...
    this.semanticLabel,
    this.excludeSemantics = false,
  }) : variant = VanillaToggleGroupVariant.ghost;

  /// A hairline `border` around every option, so the set is visible while off.
  const VanillaToggleGroup.outline({
    super.key,
    this.size = .medium,
    this.style = const ToggleGroupStyler.create(),
    required this.items,
    ...
    this.semanticLabel,
    this.excludeSemantics = false,
  }) : variant = VanillaToggleGroupVariant.outline;

  final VanillaToggleGroupVariant variant;

  final VanillaToggleGroupSize size;
