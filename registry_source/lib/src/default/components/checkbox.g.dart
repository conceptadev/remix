...
class VanillaCheckbox extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return RemixCheckbox(
      key: this.key,
      style: vanillaCheckboxStyle(style: this.style),
...
/// both.
class VanillaCheckboxGroupItem<T extends Object> extends StatelessWidget {
  const VanillaCheckboxGroupItem({
    super.key,
    this.style = const CheckboxStyler.create(),
    required this.value,
    required this.label,
  ...
  Widget build(BuildContext context) {
    return RemixCheckboxGroupItem<T>(
      key: this.key,
      style: vanillaCheckboxGroupItemStyle(style: this.style),
      value: this.value,
      label: this.label,
      semanticLabel: this.semanticLabel,
      enabled: this.enabled,
