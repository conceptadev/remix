...
/// VanillaProgress(
///   value: 0.4,
///   style: ProgressStyler().indicatorColor(VanillaTokens.destructive()),
/// )
/// ```
@MixWidget(target: RemixProgress.new)
ProgressStyler vanillaProgressStyle({
  ProgressStyler style = const ProgressStyler.create(),
    ...
    .track(_bar().width(double.infinity).color(VanillaTokens.muted()))
    .indicator(_bar().color(VanillaTokens.primary()))
    .merge(style);
