...
class UiDisclosure extends StatelessWidget {
  const UiDisclosure({
    super.key,
  ...
  }) : variant = UiDisclosureVariant.surface;

  const UiDisclosure.soft({
    super.key,
    this.size = .size2,
    this.style = const DisclosureStyler.create(),
    required this.trigger,
  ...
  }) : variant = UiDisclosureVariant.soft;
