...
class PlaygroundMessage extends StatelessWidget {
  const PlaygroundMessage({
    ...
    this.style = const PlaygroundMessageStyler.create(),
    this.styleSpec,
  });
  ...
  final PlaygroundMessageSpec? styleSpec;
  ...
  Widget build(BuildContext context) {
    return RemixStyleSpecBuilder<PlaygroundMessageSpec>(
      style: style,
      styleSpec: styleSpec,
  ...
  Widget? _avatarSlot(PlaygroundMessageSpec spec) {
...
class PlaygroundMessageCollapsible extends StatefulWidget {
  const PlaygroundMessageCollapsible({
    super.key,
    required this.child,
    this.expanded,
    ...
    this.style = const PlaygroundMessageCollapsibleStyler.create(),
    this.styleSpec,
  });
  ...
  final PlaygroundMessageCollapsibleStyler style;
  final PlaygroundMessageCollapsibleSpec? styleSpec;

  @override
  State<PlaygroundMessageCollapsible> createState() =>
      _PlaygroundMessageCollapsibleState();
}

class _PlaygroundMessageCollapsibleState
    extends State<PlaygroundMessageCollapsible> {
  ...
  @override
  void didUpdateWidget(PlaygroundMessageCollapsible oldWidget) {
  ...
  @override
  Widget build(BuildContext context) {
    return RemixStyleSpecBuilder<PlaygroundMessageCollapsibleSpec>(
      style: widget.style,
...
@MixableSpec(target: PlaygroundMessage.new)
@immutable
final class PlaygroundMessageSpec with _$PlaygroundMessageSpec {
  @override
  final double? maxWidth;
  @override
...
@MixableSpec(target: PlaygroundMessageCollapsible.new)
@immutable
final class PlaygroundMessageCollapsibleSpec
  ...
  const PlaygroundMessageCollapsibleSpec({
