...
class PlaygroundLineChart extends StatelessWidget {
  const PlaygroundLineChart({
    super.key,
  ...
  Widget build(BuildContext context) {
    return LineChart(
      key: this.key,
      style: playgroundLineChartStyle(
...
///
/// [style] merges last, so one call site can replace any part of the recipe.
class PlaygroundBarChart extends StatelessWidget {
  const PlaygroundBarChart({
    super.key,
    this.palette,
  ...
  Widget build(BuildContext context) {
    return BarChart(
      key: this.key,
      style: playgroundBarChartStyle(palette: this.palette, style: this.style),
      groups: this.groups,
      xAxis: this.xAxis,
      yAxis: this.yAxis,
      topAxis: this.topAxis,
