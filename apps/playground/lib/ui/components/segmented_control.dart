...
_PlaygroundSegmentedControlMetrics _metricsFor(
  ...
  // The type and icon scale is the family's — 14/14/16 and 16/16/18, the same
  // as the button, toggle, and tab. Only the heights differ, because a segment
  // is inset inside the track by [_trackInset] on both sides and the *track*
  // is what has to line up with the button beside it.
  .small => (
    minHeight: 26.0,
    paddingX: 10.0,
    gap: 6.0,
