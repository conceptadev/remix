...
/// Hovering promotes the icons and leaves the title alone.
///
/// The title is already at full strength, so brightening it too would leave
/// the open state with nothing left to say.
AccordionStyler _hoverStyle() => _icons(PlaygroundTokens.foreground());
