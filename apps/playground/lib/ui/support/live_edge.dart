...
class PlaygroundLiveEdgeEngine {
  PlaygroundLiveEdgeEngine({
...
class PlaygroundLiveEdgeScrollView extends StatefulWidget {
  const PlaygroundLiveEdgeScrollView({
    super.key,
    required this.child,
  ...
  @override
  State<PlaygroundLiveEdgeScrollView> createState() =>
      _PlaygroundLiveEdgeScrollViewState();
}

class _PlaygroundLiveEdgeScrollViewState
    extends State<PlaygroundLiveEdgeScrollView> {
  ...
  @override
  void didUpdateWidget(PlaygroundLiveEdgeScrollView oldWidget) {
