...
TextFieldStyler _base() => TextFieldStyler()
    ...
    .text(.fontSize(_textSize).color(UiTokens.foreground()))
    // The placeholder is not the value: it has to read as the quieter of the
    // two, or an empty field looks filled in.
    .hintText(.fontSize(_textSize).color(UiTokens.mutedForeground()))
    .cursorColor(UiTokens.foreground())
    .label(
      .fontSize(
        _labelSize,
      ).fontWeight(FontWeight.w500).color(UiTokens.foreground()),
    )
    .helperText(.fontSize(_labelSize).color(UiTokens.mutedForeground()))
...
TextFieldStyler _errorStyle() => TextFieldStyler().variant(
  ...
  TextFieldStyler()
      .border(.color(UiTokens.destructive()).width(_borderWidth))
      .helperText(.color(UiTokens.foreground()).fontWeight(FontWeight.w500)),
);
