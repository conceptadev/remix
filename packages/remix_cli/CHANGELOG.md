...
- Bundles a registry item for every component in `remix` 1.0.0-beta.6: theme
  plus accordion, avatar, badge, button, callout, card, checkbox, data_list,
  data_table, dialog, divider, icon_button, link, menu, popover, progress,
  radio, segmented_control, select, skeleton, slider, spinner, switch, tabs,
