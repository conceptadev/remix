...
mixin _$RemixDialogSpec implements Spec<RemixDialogSpec>, Diagnosticable {
  ...
  @override
  List<Object?> get props => [container, effects, title, description, actions];
...
class RemixDialogStyler extends MixStyler<RemixDialogStyler, RemixDialogSpec>
  ...
  factory RemixDialogStyler.effects(RemixSurfaceEffectsMix value) =>
      RemixDialogStyler().effects(value);
  ...
  /// Sets the effects.
  RemixDialogStyler effects(RemixSurfaceEffectsMix value) {
    return merge(RemixDialogStyler(effects: value));
  }
