...
class FortalTextField extends StatelessWidget {
  ...
  const FortalTextField.classic({
    ...
    this.semanticHint,
    this.excludeSemantics = false,
  }) : variant = FortalTextFieldVariant.classic;
...
class FortalTextArea extends StatelessWidget {
  const FortalTextArea({
    super.key,
    this.variant = .surface,
    this.size = .size2,
    this.controller,
  ...
  const FortalTextArea.classic({
    ...
    this.semanticHint,
    this.excludeSemantics = false,
  }) : variant = FortalTextAreaVariant.classic;
  ...
  const FortalTextArea.surface({
    ...
    this.semanticHint,
    this.excludeSemantics = false,
  }) : variant = FortalTextAreaVariant.surface;
  ...
  const FortalTextArea.soft({
    ...
    this.semanticHint,
    this.excludeSemantics = false,
  }) : variant = FortalTextAreaVariant.soft;
