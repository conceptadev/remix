...
Fortal includes the complete 318-glyph Radix Icons 1.3.2 catalog as static
`FortalIcons` constants so Flutter can subset the font. There is no
name-to-icon map on that class.
