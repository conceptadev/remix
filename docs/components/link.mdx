...
<Info>
  See the [fortalLinkStyle source code](https://github.com/conceptadev/remix/blob/main/packages/remix_fortal/lib/src/components/link.dart) for all available options.
</Info>
