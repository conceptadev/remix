...
class LinkUrlExample extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return RemixLink(
      ...
      linkUrl: Uri.parse('https://github.com/conceptadev/remix'),
...
<Info>
  See the [fortalLinkStyle source code](https://github.com/conceptadev/remix/blob/main/registry_source/lib/src/fortal/components/link.dart) for all available options.
</Info>
