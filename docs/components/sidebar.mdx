...
the latest target without animation.
...
and ease-in-out. Text phases scale with the chosen duration. Set
...
<CodeGroup title="Animated icon rail" defaultLanguage="dart">
```dart
...
collapsed, preserving theme scaling. The dashboard uses 256px and 72px widths;
