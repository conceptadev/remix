...
<Info>
  See the [fortalDialogStyle source code](https://github.com/conceptadev/remix/blob/main/packages/remix_fortal/lib/src/components/dialog.dart) for all available options.
</Info>
