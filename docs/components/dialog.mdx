...
<Info>
  See the [fortalDialogStyle source code](https://github.com/conceptadev/remix/blob/main/registry_source/lib/src/fortal/components/dialog.dart) for all available options.
</Info>
