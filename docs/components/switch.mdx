...
<Info>
  See the [fortalSwitchStyle source code](https://github.com/conceptadev/remix/blob/main/registry_source/lib/src/fortal/components/switch.dart) for all available options.
</Info>
