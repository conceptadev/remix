...
<Info>
  See the [fortalSwitchStyle source code](https://github.com/btwld/remix/blob/main/packages/remix/lib/src/components/switch/fortal_switch_styles.dart) for all available options.
</Info>
