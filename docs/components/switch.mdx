...
<Info>
  See the [fortalSwitchStyle source code](https://github.com/conceptadev/remix/blob/main/packages/remix_fortal/lib/src/components/switch.dart) for all available options.
</Info>
