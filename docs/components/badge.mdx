...
<Info>
  See the [fortalBadgeStyle source code](https://github.com/conceptadev/remix/blob/main/packages/remix_fortal/lib/src/components/badge.dart) for all available options.
</Info>
