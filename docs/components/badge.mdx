...
<Info>
  See the [fortalBadgeStyle source code](https://github.com/conceptadev/remix/blob/main/registry_source/lib/src/fortal/components/badge.dart) for all available options.
</Info>
