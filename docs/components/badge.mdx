...
<Info>
  See the [fortalBadgeStyle source code](https://github.com/btwld/remix/blob/main/packages/remix/lib/src/components/badge/fortal_badge_styles.dart) for all available options.
</Info>
