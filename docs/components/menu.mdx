...
<CodeGroup title="Builder-backed avatar trigger" defaultLanguage="dart">
```dart
import 'package:flutter/material.dart';
import 'package:remix/remix.dart';
import 'ui/ui.dart';
...
<Info>
  See the [fortalMenuStyle source code](https://github.com/conceptadev/remix/blob/main/registry_source/lib/src/fortal/components/menu.dart) for all available options.
</Info>
