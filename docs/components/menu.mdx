...
<Info>
  See the [fortalMenuStyle source code](https://github.com/conceptadev/remix/blob/main/packages/remix_fortal/lib/src/components/menu.dart) for all available options.
</Info>
