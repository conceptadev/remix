...
<Info>
  See the [fortalCalloutStyle source code](https://github.com/btwld/remix/blob/main/packages/remix/lib/src/components/callout/fortal_callout_styles.dart) for all available options.
</Info>
