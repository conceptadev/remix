...
<Info>
  See the [fortalCalloutStyle source code](https://github.com/conceptadev/remix/blob/main/registry_source/lib/src/fortal/components/callout.dart) for all available options.
</Info>
