...
<Info>
  See the [fortalCalloutStyle source code](https://github.com/conceptadev/remix/blob/main/packages/remix_fortal/lib/src/components/callout.dart) for all available options.
</Info>
