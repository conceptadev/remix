...
<Info>
  See the [fortalSliderStyle source code](https://github.com/conceptadev/remix/blob/main/registry_source/lib/src/fortal/components/slider.dart) for all available options.
</Info>
