...
<Info>
  See the [fortalSliderStyle source code](https://github.com/conceptadev/remix/blob/main/packages/remix_fortal/lib/src/components/slider.dart) for all available options.
</Info>
