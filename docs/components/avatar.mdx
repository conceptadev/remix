...
<Info>
  ...
  the pinned two-initial typography. See the [fortalAvatarStyle source code](https://github.com/conceptadev/remix/blob/main/registry_source/lib/src/fortal/components/avatar.dart) for all available options.
</Info>
