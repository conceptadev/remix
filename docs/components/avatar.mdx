...
<Info>
  ...
  the pinned two-initial typography. See the [fortalAvatarStyle source code](https://github.com/conceptadev/remix/blob/main/packages/remix_fortal/lib/src/components/avatar.dart) for all available options.
</Info>
