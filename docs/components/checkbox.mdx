...
<Info>
  See the [fortalCheckboxStyle source code](https://github.com/conceptadev/remix/blob/main/packages/remix_fortal/lib/src/components/checkbox.dart) for all available options.
</Info>
