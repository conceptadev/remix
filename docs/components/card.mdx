...
<Info>
  See the [fortalCardStyle source code](https://github.com/btwld/remix/blob/main/packages/remix/lib/src/components/card/fortal_card_styles.dart) for all available options.
</Info>
