...
<Info>
  See the [fortalCardStyle source code](https://github.com/conceptadev/remix/blob/main/packages/remix_fortal/lib/src/components/card.dart) for all available options.
</Info>
