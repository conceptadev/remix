...
<Info>
  See the [fortalSpinnerStyle source code](https://github.com/conceptadev/remix/blob/main/registry_source/lib/src/fortal/components/spinner.dart) for all available options.
</Info>
