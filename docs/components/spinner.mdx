...
<Info>
  See the [fortalSpinnerStyle source code](https://github.com/conceptadev/remix/blob/main/packages/remix_fortal/lib/src/components/spinner.dart) for all available options.
</Info>
