...
<Info>
  See the [fortalCheckboxGroupItemStyle source code](https://github.com/conceptadev/remix/blob/main/packages/remix_fortal/lib/src/components/checkbox.dart) for all available options.
</Info>
