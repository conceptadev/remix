...
<Info>
  See the [fortalCheckboxGroupItemStyle source code](https://github.com/conceptadev/remix/blob/main/registry_source/lib/src/fortal/components/checkbox.dart) for all available options.
</Info>
