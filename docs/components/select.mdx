...
<Info>
  ...
  See the [fortalSelectStyle source code](https://github.com/conceptadev/remix/blob/main/registry_source/lib/src/fortal/components/select.dart) for all available options.
</Info>
