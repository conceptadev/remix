...
<Info>
  ...
  See the [fortalSelectStyle source code](https://github.com/conceptadev/remix/blob/main/packages/remix_fortal/lib/src/components/select.dart) for all available options.
</Info>
