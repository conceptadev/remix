...
<Info>
  See the [fortalDividerStyle source code](https://github.com/conceptadev/remix/blob/main/registry_source/lib/src/fortal/components/divider.dart) for all available options.
</Info>
