...
<Info>
  See the [fortalDividerStyle source code](https://github.com/btwld/remix/blob/main/packages/remix/lib/src/components/divider/fortal_divider_styles.dart) for all available options.
</Info>
