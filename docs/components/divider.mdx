...
<Info>
  See the [fortalDividerStyle source code](https://github.com/conceptadev/remix/blob/main/packages/remix_fortal/lib/src/components/divider.dart) for all available options.
</Info>
