...
<Info>
  See the [fortalToggleStyle source code](https://github.com/btwld/remix/blob/main/packages/remix/lib/src/components/toggle/fortal_toggle_styles.dart) for all available options.
</Info>
