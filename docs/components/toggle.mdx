...
<Info>
  See the [fortalToggleStyle source code](https://github.com/conceptadev/remix/blob/main/registry_source/lib/src/fortal/components/toggle.dart) for all available options.
</Info>
