...
<Info>
  See the [fortalToggleStyle source code](https://github.com/conceptadev/remix/blob/main/packages/remix_fortal/lib/src/components/toggle.dart) for all available options.
</Info>
