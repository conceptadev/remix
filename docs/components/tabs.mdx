...
<Info>
  See the [fortalTabStyle source code](https://github.com/btwld/remix/blob/main/packages/remix/lib/src/components/tabs/fortal_tabs_styles.dart) for all available options.
</Info>
