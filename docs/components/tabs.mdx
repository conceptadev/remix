...
<Info>
  See the [fortalTabStyle source code](https://github.com/conceptadev/remix/blob/main/packages/remix_fortal/lib/src/components/tabs.dart) for all available options.
</Info>
