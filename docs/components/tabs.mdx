...
<Info>
  See the [fortalTabStyle source code](https://github.com/conceptadev/remix/blob/main/registry_source/lib/src/fortal/components/tabs.dart) for all available options.
</Info>
