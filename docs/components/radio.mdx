...
<Info>
  See the [fortalRadioStyle source code](https://github.com/conceptadev/remix/blob/main/registry_source/lib/src/fortal/components/radio.dart) for all available options.
</Info>
