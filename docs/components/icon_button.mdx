...
<Info>
  See the [fortalIconButtonStyle source code](https://github.com/btwld/remix/blob/main/packages/remix/lib/src/components/icon_button/fortal_icon_button_styles.dart) for all available options.
</Info>
