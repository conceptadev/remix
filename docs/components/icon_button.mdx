...
<Info>
  See the [fortalIconButtonStyle source code](https://github.com/conceptadev/remix/blob/main/packages/remix_fortal/lib/src/components/icon_button.dart) for all available options.
</Info>
