...
<Info>
  See the [fortalButtonStyle source code](https://github.com/conceptadev/remix/blob/main/packages/remix_fortal/lib/src/components/button.dart) for all available options.
</Info>
