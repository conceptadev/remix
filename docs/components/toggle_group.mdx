  ...
  return RemixToggleGroup<String>(
    ...
    style: ToggleGroupStyler().item(
      ToggleGroupItemStyler()
          ...
          .paddingY(8)
          .onSelected(
            ToggleGroupItemStyler().backgroundColor(Colors.green.shade50),
          ),
    ),
  );
}
...
<Info>
  See the [fortalToggleGroupStyle source code](https://github.com/btwld/remix/blob/main/packages/remix/lib/src/components/toggle_group/fortal_toggle_group_styles.dart) for all available options.
</Info>
