...
<Info>
  See the [fortalToggleGroupStyle source code](https://github.com/conceptadev/remix/blob/main/packages/remix_fortal/lib/src/components/toggle_group.dart) for all available options.
</Info>
