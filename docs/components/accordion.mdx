...
<Info>
  See the [fortalAccordionStyle source code](https://github.com/conceptadev/remix/blob/main/packages/remix_fortal/lib/src/components/accordion.dart) for all available options.
</Info>
