...
<Info>
  See the [fortalAccordionStyle source code](https://github.com/btwld/remix/blob/main/packages/remix/lib/src/components/accordion/fortal_accordion_styles.dart) for all available options.
</Info>
