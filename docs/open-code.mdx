...
Until Remix beta.8 is published, add this temporary `pubspec_overrides.yaml`
...
installation below. Both presets require Remix `^1.0.0-beta.8`.
...
The registry requires Remix beta.8, which includes `RemixSidebar`.
